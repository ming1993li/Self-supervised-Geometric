...
name_module_class_mapping = {
    'cam': CAM_Module,
    'normed_cam': Normed_CAM_Module,
    'pam': PAM_Module,
    'normed_pam': Normed_PAM_Module,
    'second_order_cam': Second_Order_CAM_Module,
    'second_order_pam': Second_Order_PAM_Module,
    'multi_order_cam': Multi_Order_CAM_Module,
    'multi_order_pam': Multi_Order_PAM_Module,
    'identity': Identity,
}
...
def get_attention_module_instance(
    ...
    *,
    ...
    name = name.lower()
    assert name in name_module_class_mapping.keys()
